  ...
  <body>
    ...
    <script>
      function calculateGrade() {
        ...
        var Projectscore = parseFloat(document.getElementById("project").value);
        var LAweight = 0.3;
        var LEweight = 0.3;
        var FEweight = 0.4;
        ...
        var FEProjweightedAve = (FEscore + Projectscore) / 2;
        var FEProjweightedScore = FEProjweightedAve * FEweight;
        
        // Calculate semestral grade
        var semestralGrade = LAweightedScore * LAweight + LEweightedScore + FEProjweightedScore;
        
        // Display result as a string
        document.getElementById("LAtotal").innerHTML = "Learning Average: " + LAweightedScore.toFixed(2);
